 ...
 */
 ...
 activePerson+" currently has nothing checked out under "+activePerson.getGenderPossessivePronoun(activePerson)+" name.":

 activePerson+" has the following titles checked out under "+activePerson.getGenderPossessivePronoun(activePerson)+" name.";
